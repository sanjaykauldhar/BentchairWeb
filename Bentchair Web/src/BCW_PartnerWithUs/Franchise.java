...
public class Franchise {
  ...
  public void testFranchise() throws Exception {
    ...
    driver.findElement(By.xpath("(.//*[normalize-space(text()) and normalize-space(.)='Become a franchisee/retailer'])[1]/following::button[1]")).click();
    ...
    BYA_Form.form_company(driver).sendKeys("Franchise Company");
    ...
    BYA_Form.form_message(driver).sendKeys("BOOKED AN APPOINTMENT FOR FRANCHISE SUCCESSFULLY!");
