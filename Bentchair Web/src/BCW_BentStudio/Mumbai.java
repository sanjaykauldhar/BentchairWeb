...
public class Mumbai {
  ...
  @Test
  public void testMumbai() throws Exception {
    ...
    driver.findElement(By.xpath("//*[@id=\"content\"]/div/div/div[3]/div/div/a/img")).click();
    ...
    form_company.sendKeys("Mumbai Ltd");
    ...
    form_message.sendKeys("BOOKED AN APPOINTMENT FOR BENT STUDIO MUMBAI SUCCESSFULLY!");
