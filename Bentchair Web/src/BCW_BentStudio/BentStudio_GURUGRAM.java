...
public class BentStudio_GURUGRAM {
  ...
  @Test
  public void testBentStudio_GURUGRAM() throws Exception {
    ...
    WebElement BENT_STUDIO_GURUGRAM = driver.findElement(By.xpath("//*[@id=\"content\"]/div/div/div[2]/div[1]/div/div[2]/a/img"));
    JavascriptExecutor executor10 = (JavascriptExecutor) driver;
    executor10.executeScript("arguments[0].click();", BENT_STUDIO_GURUGRAM);
