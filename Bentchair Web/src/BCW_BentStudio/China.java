...
public class China {
  ...
  public void testChina() throws Exception {
    ...
    driver.findElement(By.xpath("//*[@id=\"content\"]/div/div/div[4]/div[2]/div/a/img")).click();
    ...
    form_company.sendKeys("China Ltd");
    ...
    form_message.sendKeys("BOOKED AN APPOINTMENT FOR BENT STUDIO CHINA SUCCESSFULLY!");
