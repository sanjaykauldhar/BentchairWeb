...
public class BentStudio_DELHI {
  ...
  @Test
  public void testBentStudio_DELHI() throws Exception {
    ...
    WebElement BENT_STUDIO_DELHI = driver.findElement(By.xpath("//img[@alt='Delhi studio Image']"));
    JavascriptExecutor executor10 = (JavascriptExecutor) driver;
    executor10.executeScript("arguments[0].click();", BENT_STUDIO_DELHI);
    
    WebElement BOOK_AN_APPOINTMENT = driver.findElement(By.xpath("//button[@class='btn btn-primary btn-lg westend-btn']"));
    ...
    form_message.sendKeys("BOOKED AN APPOINTMENT FOR BENT STUDIO DELHI SUCCESSFULLY!");
    ...
    wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//button[@class='btn btn-primary btn-lg westend-btn']")));
