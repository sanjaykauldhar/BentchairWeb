...
public class Raipur {
  ...
  @Test
  public void testRaipur() throws Exception {
    ...
    driver.findElement(By.xpath("//*[@id=\"content\"]/div/div/div[6]/div/div/a/img")).click();
    ...
    form_company.sendKeys("Raipur Ltd");
    ...
    form_message.sendKeys("BOOKED AN APPOINTMENT FOR BENT STUDIO RAIPUR SUCCESSFULLY!");
