...
public class Tirupati {
  ...
  @Test
  public void testTirupati() throws Exception {
    ...
    driver.findElement(By.xpath("//*[@id=\"content\"]/div/div/div[7]/div[1]/div/a/img")).click();
    ...
    form_company.sendKeys("Tirupati Ltd");
    ...
    form_message.sendKeys("BOOKED AN APPOINTMENT FOR BENT STUDIO TIRUPATI SUCCESSFULLY!");
