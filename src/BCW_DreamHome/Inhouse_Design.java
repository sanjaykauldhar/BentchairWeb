...
public class Inhouse_Design {
  ...
  @Test
  public void testInhouse_Design() throws Exception {
    ...
    WebElement INHOUSE_DESIGN = driver.findElement(By.xpath("//img[@alt='In-House-Design']"));
    JavascriptExecutor executor1 = (JavascriptExecutor) driver;
    executor1.executeScript("arguments[0].click();", INHOUSE_DESIGN);
